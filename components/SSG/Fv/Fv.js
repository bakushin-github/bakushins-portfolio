...
function Fv() {
  ...
  const totalBElementsToComplete = 2; // header_ball, polygon1
  ...
  return (
    <>
      <div id="Fv" className={styles.fv} style={{ height: "100vh" }}>
        {/* A Elements: マスクアニメーションで線が少しずつ表示 */}
        <motion.img
        ...
        {/* SVG Animation */}
        {shouldTriggerAnimation && imageTextAnimationComplete && (
